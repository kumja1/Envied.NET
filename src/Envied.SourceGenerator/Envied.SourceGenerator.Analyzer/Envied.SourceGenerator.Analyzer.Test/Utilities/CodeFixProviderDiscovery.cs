...
namespace Envied.SourceGenerator.Analyzer.Test.Utilities
{
        ...
        static CodeFixProviderDiscovery()
        {
            ExportProviderFactory = new Lazy<IExportProviderFactory>(
                () =>
                {
                    ...
                    var parts = Task.Run(() => discovery.CreatePartsAsync(typeof(Envied.SourceGenerator.AnalyzerCodeFixProvider).Assembly)).GetAwaiter().GetResult();
