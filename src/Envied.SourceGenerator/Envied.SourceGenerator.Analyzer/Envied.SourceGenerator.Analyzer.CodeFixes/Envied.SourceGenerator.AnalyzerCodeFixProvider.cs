...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Envied.SourceGenerator.AnalyzerCodeFixProvider)), Shared]
    public class Envied.SourceGenerator.AnalyzerCodeFixProvider : CodeFixProvider
    {
        private static string CodeFixTitle = "Convert to upper";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(Envied.SourceGenerator.AnalyzerAnalyzer.DiagnosticId); }
        }
