    ...
    where T : IEquatable<T>
{
    ...
    public bool Equals(ValueEquatableArray<T> other) => _items.AsSpan().SequenceEqual(other._items);

    public override bool Equals(object obj) => obj is ValueEquatableArray<T> other && Equals(other);
